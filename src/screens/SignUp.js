...
import { View, Text, StyleSheet, TouchableHighlight, TextInput, Keyboard } from 'react-native'
    ...
    render(){
        return(
            ...
            <View style={styles.container}>
                ...
                <Text style={{margin:10}}>Digite seu Nome:</Text>
                ...
                <TouchableHighlight style={styles.button}  onPress={()=>{
                    ...
                    this.props.SignUpAction(this.props.name, this.props.email, this.props.password,()=>{this.setState({loading:false})})
                    }} ><Text style={styles.buttonTxt}>Cadastrar</Text></TouchableHighlight>
...
const SignUpConnect = connect(mapStateToProps, { checkLogin, changeEmail, changePassword, changeName, SignUpAction, getChatsList, getContactsList })(SignUp)
